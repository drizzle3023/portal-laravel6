    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">@lang('messages.Add Customer')</h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">@lang('messages.App')</li>
                        <li class="breadcrumb-item " aria-current="page">@lang('messages.Customer')</li>
            ...
            <div class="block-content">
                ...
                @if ($message = Session::get('success'))
                    <div class="alert alert-success alert-block">
                        ...
                        <strong>@lang('messages.First login password is: ') {{Session::get('password')}}</strong>
                    </div>
                @endif
                ...
                <form action="{{url('/customer/add')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Vital Info -->
                    ...
                    <div class="row push">
                        <div class="col-lg-8 col-xl-5 offset-lg-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning" href="{{url('/customer')}}">
