    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">@lang('messages.Edit Domain')</h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">@lang('messages.App')</li>
                        <li class="breadcrumb-item " aria-current="page">@lang('messages.Domain')</li>
    ...
    <div class="content">
        <div class="block block-rounded block-bordered">
            <div class="block-content">
                ...
                <form action="{{url('/domains/edit')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Vital Info -->
                    ...
                    <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="domain" placeholder="Domain" value="{{$domain->domain}}">
                            </div>
                    ...
                    <div class="row push">
                        <div class="col-lg-8 col-xl-5 offset-lg-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning" href="{{url('/domains/'.$domain->customer_id)}}">
